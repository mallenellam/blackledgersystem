...
CREATE TABLE public.character_gear (
  ...
  CONSTRAINT character_gear_gear_id_fkey FOREIGN KEY (gear_id) REFERENCES public.gear(id)
);
...
CREATE TABLE public.characters (
  ...
  soul_die_size integer NOT NULL DEFAULT 8,
  base_soul_die_size integer NOT NULL DEFAULT 8,
  muscle_die_size integer NOT NULL DEFAULT 8,
  reflex_die_size integer NOT NULL DEFAULT 8,
  intellect_die_size integer NOT NULL DEFAULT 8,
  insight_die_size integer NOT NULL DEFAULT 8,
  presence_die_size integer NOT NULL DEFAULT 8,
...
CREATE TABLE public.crew_storage (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  crew_id uuid,
  item_name text,
  item_type text,
  ...
  CONSTRAINT crew_storage_pkey PRIMARY KEY (id),
  CONSTRAINT crew_storage_crew_id_fkey FOREIGN KEY (crew_id) REFERENCES public.crews(id)
);
...
CREATE TABLE public.cyberdeck_slots (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  cyberdeck_id uuid,
  program_id uuid,
  ...
  created_at timestamp with time zone DEFAULT now(),
  CONSTRAINT cyberdeck_slots_pkey PRIMARY KEY (id),
  CONSTRAINT cyberdeck_slots_cyberdeck_id_fkey FOREIGN KEY (cyberdeck_id) REFERENCES public.cyberdecks(id),
  CONSTRAINT cyberdeck_slots_program_id_fkey FOREIGN KEY (program_id) REFERENCES public.programs(id)
);
CREATE TABLE public.cyberdecks (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  character_id uuid,
  name text NOT NULL,
  brand text,
  base_bandwidth integer DEFAULT 4,
  current_bandwidth integer DEFAULT 4,
  slots integer DEFAULT 4,
  firewall integer DEFAULT 1,
  description text,
  created_at timestamp with time zone DEFAULT now(),
  CONSTRAINT cyberdecks_pkey PRIMARY KEY (id),
  CONSTRAINT cyberdecks_character_id_fkey FOREIGN KEY (character_id) REFERENCES public.characters(id)
);
CREATE TABLE public.cyberware (
  ...
  slot text NOT NULL,
  description text,
  install_cost integer DEFAULT 1000,
...
CREATE TABLE public.gear (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  name text NOT NULL,
  type text NOT NULL CHECK (type = ANY (ARRAY['weapon'::text, 'armor'::text, 'tool'::text, 'item'::text])),
  description text,
...
CREATE TABLE public.haul_items (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  haul_id uuid,
  item_name text,
  item_type text,
  ...
  CONSTRAINT haul_items_pkey PRIMARY KEY (id),
  CONSTRAINT haul_items_haul_id_fkey FOREIGN KEY (haul_id) REFERENCES public.hauls(id),
  CONSTRAINT haul_items_assigned_to_fkey FOREIGN KEY (assigned_to) REFERENCES public.characters(id)
);
CREATE TABLE public.haul_split_suggestions (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  haul_id uuid,
  character_id uuid,
  suggestion jsonb,
  created_at timestamp with time zone DEFAULT now(),
  CONSTRAINT haul_split_suggestions_pkey PRIMARY KEY (id),
  CONSTRAINT haul_split_suggestions_haul_id_fkey FOREIGN KEY (haul_id) REFERENCES public.hauls(id),
  CONSTRAINT haul_split_suggestions_character_id_fkey FOREIGN KEY (character_id) REFERENCES public.characters(id)
);
CREATE TABLE public.hauls (
  ...
  created_at timestamp with time zone DEFAULT now(),
  CONSTRAINT hauls_pkey PRIMARY KEY (id),
  CONSTRAINT hauls_job_id_fkey FOREIGN KEY (job_id) REFERENCES public.jobs(id),
  CONSTRAINT hauls_crew_id_fkey FOREIGN KEY (crew_id) REFERENCES public.crews(id)
);
...
CREATE TABLE public.loot_tables (
  ...
  base_value integer DEFAULT 500,
...
CREATE TABLE public.persona_catalog (
  ...
  tagline text,
  summary text,
  CONSTRAINT persona_catalog_pkey PRIMARY KEY (persona_code)
);
CREATE TABLE public.persona_modifiers (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  persona_code text,
  action_type text NOT NULL,
  control_delta integer DEFAULT 0,
  entropy_delta integer DEFAULT 0,
  notes text,
  CONSTRAINT persona_modifiers_pkey PRIMARY KEY (id),
  CONSTRAINT persona_modifiers_persona_code_fkey FOREIGN KEY (persona_code) REFERENCES public.persona_catalog(persona_code)
);
...
CREATE TABLE public.programs (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  name text NOT NULL,
  type text NOT NULL CHECK (type = ANY (ARRAY['offensive'::text, 'defensive'::text, 'utility'::text, 'daemon'::text])),
  description text,
  bandwidth_cost integer DEFAULT 1,
  base_damage_die text,
  special_effect text,
  rarity text DEFAULT 'common'::text,
  created_at timestamp with time zone DEFAULT now(),
...
CREATE TABLE public.run_personas (
  ...
  CONSTRAINT run_personas_pkey PRIMARY KEY (id),
  CONSTRAINT run_personas_run_id_fkey FOREIGN KEY (run_id) REFERENCES public.runs(id),
  CONSTRAINT run_personas_character_id_fkey FOREIGN KEY (character_id) REFERENCES public.characters(id),
  CONSTRAINT run_personas_assigned_by_fkey FOREIGN KEY (assigned_by) REFERENCES public.characters(id)
);
...
CREATE TABLE public.skills (
  ...
  attribute text CHECK (attribute = ANY (ARRAY['muscle'::text, 'reflex'::text, 'intellect'::text, 'insight'::text, 'presence'::text])),
  description text,
  created_at timestamp with time zone DEFAULT now(),
